  ...
  return (
    <div className="flex items-center shadow rounded-lg w-full bg-gray-100 border-gray-100">
      ...
      <div className="flex p-5 items-center justify-center">
        <button
          onClick={ onAddToCart }
          className="text-white bg-sky-600 hover:bg-sky-500 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">
            <IoAddCircleOutline size={25} />
        </button>
        <span className="text-2xl  mx-10">{quantity}</span>
        <button
          onClick={onRemoveItem}
          className="text-white bg-cyan-600 hover:bg-cyan-800  font-medium rounded-lg text-sm px-5 py-2.5 text-center ">
            <IoRemove size={25} />
        </button>
      </div>
    </div>
